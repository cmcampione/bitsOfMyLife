...
export const updateMilestone = createAction('[BitsOfMyLife] Update Milestone', props<{ milestoneToEdit: MilestoneToUpdate }>());
export const milestoneUpdated = createAction('[BitsOfMyLife] Update Milestone Success', props<{ updatedMilestone: Milestone }>());

export const deleteMilestoneById = createAction("[BitOfMyLife] Delete Milestone by Id", props<{ milestoneIdToRemove: string }>());
export const milestoneDeleted = createAction('[BitOfMyLife] Delete Milestone by Id Success', props<{ milestoneIdToRemove: string }>());
...
export const timelineSelected = createAction('[BitsOfMyLife] Select Timeline by Id Success', props<{ timelineId: string }>());
...
export const updateTimeline = createAction('[BitsOfMyLife] Update Timeline', props<{ timelineToEdit: Timeline }>());
export const timelineUpdated = createAction('[BitsOfMyLife] Update Timeline Success', props<{ updatedTimeline: Timeline }>());

export const deleteTimelineById = createAction("[BitOfMyLife] Delete Timeline by Id", props<{ timelineIdToRemove: string }>());
export const timelineDeleted = createAction('[BitsOfMyLife] Delete Timeline by Id Success', props<{ timelineIdToRemove: string }>());
